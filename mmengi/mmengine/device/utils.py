...
import torch
from MB321.mm_flag import USE_GPU_LIST
gpu_str = ','.join(map(str, USE_GPU_LIST))
...
if is_npu_available():
    ...
    DEVICE = f'cuda:{gpu_str}' # *mb321*  # os.environ['CUDA_VISIBLE_DEVICES'] = '0,2'
    print(f"$$*mb321* using gpu:{gpu_str} from {USE_GPU_LIST}")
