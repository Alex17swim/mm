...
class CocoMetric(BaseMetric):
    ...
    def __init__(self,
        ...
        self.format_only = format_only; print(f"*mb321* format_only={format_only}")
        if self.format_only:
    ...
    def results2json(self, results: Sequence[dict],
        ...
        for idx, result in enumerate(results):
            ...
            for i, label in enumerate(labels):
                ...
                if label > len(self.cat_ids):
                    input(f"!!label={label}, len(cat_ids)={len(self.cat_ids)}\n\n")
                    continue
        ...
        # print(f"*mb321* result_files['bbox']={result_files['bbox']}")
        return result_files
