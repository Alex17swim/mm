# chr_mask_rcnn_r50_fpn_2x_coco.py

print("where is  chr_mask_rcnn_r50_fpn_2x_coco.py? __file__={}".format(__file__))
...
model = dict(
    ...
    roi_head=dict(
        bbox_head=dict(num_classes=NUM_CLASS_SEG),
        mask_head=dict(num_classes=NUM_CLASS_SEG) )
)

print("chr_mask_rcnn_r50_fpn_2x_coco.py, _base_={}\n load_from={}".format(_base_, load_from))
