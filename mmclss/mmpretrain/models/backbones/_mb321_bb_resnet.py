# _mb321_bb_resnet.py, Chengyu Wang, 2023-1120, last update:2023-1120
import sys, os
_import_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
sys.path.append(_import_root)
# print("_mb321_bb_resnet.py _import_root={}".format(_import_root))
...
if __name__ == '__main__':
    ...
    print(f"- main of _mb321_bb_resnet.py done at {agBASE.tm}, from {time_str(tt0)}, cost {time_gap(tt0)}")
